...
<div class="events-community-post-title">
	...
	<?php 
	// tribe_community_events_field_label( 'post_title', sprintf( __( '%s Title:', 'tribe-events-community' ), $events_label_singular ) ); ?>
	<label for="post_title" class="">レッスン・イベント名 (Lesson &amp; Event Title): <span class="req">(必須)</span></label>
