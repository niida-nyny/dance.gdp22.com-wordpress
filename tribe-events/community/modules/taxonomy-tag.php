...
<div class="tribe-section tribe-section-taxonomy">
	<div class="tribe-section-header">
		...
		参加者に求めるダンスレベル</h3>
		<span>複数選択可</span>
		<p>より多くの参加者を集めたいという理由でオールレベルを選ぶ主催者が圧倒的に多いですが、 参加する人にとっては、自分に合わないレベルのレッスン(イベント)に対する満足度は低いという声を多く聞きます。</p>
		<p>満足できなかった参加者の口コミは、そのままそのレッスン(イベント)の評価になってしまいますので、できるだけ主催するレッスン(イベント)のレベルにあった対象者を表示するようにしてください。</p>
		<p>ダンススキルを大まかに分類しましたので、レッスン(イベント)で楽しく学べる（楽しめる）と思われるレベル（複数選択可）を選択してください</p>
	...
	<div class="tribe-section-content">
		<div class="tribe-section-content-field">
			...
			<?php endif; ?>
				...
				placeholder="<?php echo esc_attr( sprintf( __( 'クリックして選択 (Search from existing %s)', 'tribe-events-community' ), $taxonomy_placeholder ) ); ?>"
