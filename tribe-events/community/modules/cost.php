...
<div class="tribe-section tribe-section-cost">
	<div class="tribe-section-header">
		...
		<h3><?php 
		// printf( esc_html__( '%s Cost', 'tribe-events-community' ), $events_label_singular ); ?>
		イベント料金(Event Cost)</h3>
	</div>
	...
	<table class="tribe-section-content">
		...
		<tr class="tribe-section-content-row">
			<td class="tribe-section-content-label">
				<?php tribe_community_events_field_label( 'EventCost', __( '料金（Cost）:', 'tribe-events-community' ) ); ?>
			</td>
			<td class="tribe-section-content-field">
				...
				<p>
					<?php printf( __( '空欄にすると表示されません。<br>また無料の場合は0を入力してください。<br>Leave blank to hide the field. Enter a 0 for %s that are free.', 'tribe-events-community' ), $events_label_plural_lowercase ); ?>
				</p>
			</td>
		</tr>
	</table>
