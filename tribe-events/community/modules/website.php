...
<div class="tribe-section tribe-section-website">
	<div class="tribe-section-header">
		<h3><?php 
		// printf( __( '%s Website', 'tribe-events-community' ), tribe_get_event_label_singular() ); ?>
		イベントWEB</h3>
	</div>
	...
	<table class="tribe-section-content">
		...
		<tr class="tribe-section-content-row">
			<td class="tribe-section-content-label">
				<?php tribe_community_events_field_label( 'EventURL', __( '外部リンク（External Link）:', 'tribe-events-community' ) ); ?>
			</td>
