...
<div class="tribe-section tribe-section-datetime event-datepickers event-time eventForm">
	<div class="tribe-section-header">
		<h3><?php 
		printf( __( '%s 日時', 'tribe-events-community' ), $events_label_singular ); ?></h3>
	</div>
	...
	<table class="tribe-section-content tribe-datetime-block">
		...
		<tr class="tribe-section-content-row">
			<td class="tribe-section-content-label">
				<?php tribe_community_events_field_label( 'EventStartDate', __( '開始(Start)/終了(End):', 'tribe-events-community' ) ); ?>
			</td>
			<td class="tribe-section-content-field">
				...
				<?php if ( class_exists( 'Tribe__Events__Timezones' ) && ! tribe_community_events_single_geo_mode() ) : ?>
					...
					<select
						...
						data-timezone-label="<?php esc_attr_e( 'タイムゾーン(Timezone):', 'tribe-events-community' ) ?>"
		...
		<tr class="tribe-section-content-row">
			...
			<td class="tribe-section-content-field">
				...
				/>
				<label for="allDayCheckbox"><?php esc_html_e( '終日イベント(All Day Event)', 'tribe-events-community' ); ?></label>
			</td>
		</tr>
